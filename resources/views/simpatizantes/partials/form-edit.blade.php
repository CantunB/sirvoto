...
<div class="container">
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
          ...
          <input  @if( !empty($simpatizante->paterno)) readonly @endif type="text" class="form-control" id="paterno" name="paterno" placeholder="Apellido Paterno" value="{{old('paterno') ?? $simpatizante->paterno }}">
        </div>
        <div class="form-group col-md-4">
          <label for="materno">Ap. Materno</label>
          <input @if( !empty($simpatizante->materno)) readonly @endif type="text" class="form-control" id="materno" name="materno" placeholder="Apellido Materno" value="{{ old('materno') ?? $simpatizante->materno }}">
        </div>
      </div>
      <div class="form-row">
          <div class="form-group col-md-4">
      ...
      <div class="form-row">
          ...
          <div class="form-group col-md-2">
            ...
            <input  readonly type="text" class="form-control" id="seccion" name="seccion"  value="{{ $simpatizante->seccion }}">
            @else
          ...
          <div class="form-group col-md-2">
            ...
            @if(!empty($simpatizante->manzana))
              <input  readonly type="text" class="form-control" id="manzana" name="manzana"  value="{{ $simpatizante->manzana }}">
              @else
