...
<div class="container">
    <div class="form-row">
        ...
        <div class="form-group col-md-4">
          ...
          <input @if( !empty($responsable->paterno)) readonly  @endif type="text" class="form-control" id="paterno" name="paterno" placeholder="Apellido Paterno" value="{{ old('paterno') ?? $responsable->apellido_paterno ?? $responsable->paterno}}" required>
        </div>
        <div class="form-group col-md-4">
          <label for="materno">Ap. Materno</label>
          <input @if( !empty($responsable->materno)) readonly  @endif type="text" class="form-control" id="materno" name="materno" placeholder="Apellido Materno" value="{{ old('materno') ?? $responsable->apellido_materno ?? $responsable->materno}}">
        </div>
      </div>
      <div class="form-row">
          <div class="form-group col-md-4">
          ...
          <div class="form-group col-md-2">
              ...
              <input @if( !empty($responsable->num_ext)) readonly  @endif type="text" class="form-control" id="num_ext" name="num_ext" placeholder="S/N" value="{{ old('num_ext') ?? $responsable->num_exterior }}">
          </div>
          <div class="form-group col-md-4">
