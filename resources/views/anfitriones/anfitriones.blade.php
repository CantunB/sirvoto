...
<div class="container">
    <div class="card">
        <div class="card-body">
        <h5 class="card-title">
            <h4>Anfitriones <span class="badge badge-info">Buscar o Crear</span></h4>
        </h5>
        <br>
        <div class="container">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="container">
                        <form class="form-inline" action="{{route('anfitriones.create')}}" method="GET">
                            {{ method_field('GET') }}
                            {{ csrf_field() }}
            ...
            <div class="container">
                <div class="card">
                    <div class="card-body">
                        @if( !empty($anfitrion->nombre))
                            @include('anfitriones.search')
                        @else
                            @include('anfitriones.create')
                        @endif
                    </div>
                </div>
            </div>
